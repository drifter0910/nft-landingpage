        ...
        <div className="grid grid-cols-1 md:grid-cols-2 container mx-auto">
          ...
          >
            <h1 className="text-5xl text-center md:text-left md:text-8xl font-primary font-semibold text-primary">
              Discover{' '}
              <span className="text-secondary underline decoration-solid">Rare 3D Collections</span>{' '}
              in the <span className="text-secondary underline decoration-solid">World</span>
            </h1>
            <p className="text-primary md:text-xl">
              The largest 3D NFT marketplace authentic and truly unique digital creation. Create
              yout own NFT dream gallery
            </p>
          ...
          <div className="hidden md:block" data-aos="fade-up" data-aos-duration="3000">
            <Spline
